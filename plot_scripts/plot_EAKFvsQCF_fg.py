...
if __name__ =='__main__':
    ...
    ocean_lev=0
    #-----------------------------
    anal_file_list=['/scratch/lililei1/kcfu/tc_mangkhut/4assimilation/0mem_all_time/cyclingDA/10_06_00/EAKF/firstguess_d02.ensmean',
                    '/scratch/lililei1/kcfu/tc_mangkhut/4assimilation/0mem_all_time/cyclingDA/10_06_00/QCF_RHF/firstguess_d02.ensmean']
    
    title_list=['EAKF','QCF_RHF']
    NR_path='/share/home/lililei1/kcfu/tc_mangkhut/NR_wrfout/wrfout_d03_2018-09-10_06:00:00'
    #-----------------------------
...
# --- Plotting with unified colorbar and jet colormap ---
    ...
    fig, ax = plt.subplots(2, len(anal_file_list) + 1, figsize=(10*(len(anal_file_list) + 1), 20)) # 稍微调小一点figsize，太大会导致字体显得极小
    ...
    # 保存图片
    save_path = f'/share/home/lililei1/kcfu/tc_mangkhut/plot_scripts/figs/EAKFvsQCF_{var}_{string}_{domain}_fg.png'
