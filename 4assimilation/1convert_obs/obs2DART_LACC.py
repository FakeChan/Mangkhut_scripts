...
if __name__ == "__main__":
    ...
    #======================================================================================
    #path
    obs_dir='/share/home/lililei1/kcfu/tc_mangkhut/3create_obs/hx_rttov/3obs_BT_LACC/AMSUA'
    ...
    min='00'
    channel=2
    obs_err_from_envs='0.5'
    obs_file=f'{obs_dir}/BT_LACC_{day}_{hour}_{min}/obs_d01_ch{channel}_totalline_withpert.txt'
    ...
    with open(f"{output_dir}/obs_{domain}/kctest_{nobs}_obsinput_{day}_{hour}_{min}_LACC.txt", "w", encoding="utf-8") as file:
        for row in data:
