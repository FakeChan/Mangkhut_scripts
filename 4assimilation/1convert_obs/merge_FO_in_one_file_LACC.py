...
if __name__ == "__main__":
    ...
    BT_DIR='/share/home/lililei1/kcfu/tc_mangkhut/3create_obs/hx_rttov/4ens_BT_LACC'
    ...
    for time in time_list:
        ...
        for i,mem in enumerate(memlist):
            ...
            subprocess.run(['ln','-sf',f'{BT_DIR}/mem{formatted_i}/{sensor}/BT_LACC_{time}/obs_{domain}_ch{ch}_totalline.txt',f'{work_dir}/{in_fname}'])
